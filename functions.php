...
function wpct_enqueue_styles() {
    // bootsrap
    wp_enqueue_style('bootsrap-style',"https://cdn.jsdelivr.net/npm/bootstrap@4.6.1/dist/css/bootstrap.min.css");
    // font awesome
    ...
    // wp custom theme
    wp_enqueue_style('wpct-style', get_stylesheet_directory_uri().'/style.css', ['bootsrap-style','font-awesome-style', 'google-font-style', 'tailwind-elements-style']);
}
...
function wpct_enqueue_scripts() {
    ...
    //bootsrap + popper
    wp_enqueue_script('bootsrap-bundle-script', 'https://cdn.jsdelivr.net/npm/bootstrap@4.6.1/dist/js/bootstrap.bundle.min.js',['jquery-script']);
    // tailwind
